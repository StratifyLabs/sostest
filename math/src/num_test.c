...
const test_t tests[] = {
    ...
    TEST_CASE(greaterthan_u64, op_u64, op_u64, 100ULL, 100ULL, >),
    TEST_CASE(greaterthanorequal_u64, op_u64, op_u64, 100ULL, 100ULL, >=),
    TEST_CASE(lessthan_u64, op_u64, op_u64, 100ULL, 100ULL, <),
    TEST_CASE(lessthanorequal_u64, op_u64, op_u64, 100ULL, 100ULL, <=),
    ...
    TEST_CASE(greaterthan_s64, op_s64, op_s64, 100ULL, 100ULL, >),
    TEST_CASE(greaterthanorequal_s64, op_s64, op_s64, 100ULL, 100ULL, >=),
    TEST_CASE(lessthan_s64, op_s64, op_s64, 100ULL, 100ULL, <),
    TEST_CASE(lessthanorequal_s64, op_s64, op_s64, 100ULL, 100ULL, <=),
    ...
    TEST_CASE(greaterthan_f, op_f, op_f, 100.0f, 100.0f, >),
    TEST_CASE(greaterthanorequal_f, op_f, op_int, 100.0f, 100.0f, >=),
    TEST_CASE(lessthan_f, op_f, op_f, 100.0f, 100.0f, <),
    ...
    TEST_CASE(greaterthan_d, op_d, op_d, 100.0, 100.0, >),
    TEST_CASE(greaterthanorequal_d, op_d, op_int, 100.0, 100.0, >=),
    TEST_CASE(lessthan_d, op_d, op_d, 100.0, 100.0, <),
    ...
    TEST_CASE(greaterthan_d, op_d, op_d, -0.125, HUGE_VAL, >),
    TEST_CASE(greaterthanorequal_d, op_d, op_d, -0.125, HUGE_VAL, >=),
    TEST_CASE(lessthan_d, op_d, op_d, HUGE_VAL, -0.125, <),
    TEST_CASE(lessthan_d, op_d, op_d, HUGE_VAL, -0.125, <=)
